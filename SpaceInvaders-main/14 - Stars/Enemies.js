...
{   constructor()
    {   this.list = 
            [   
                new Enemy(100, 100, 140, 100, "enemy.png"),
                new Enemy(245, 100, 140, 100, "enemy.png"),
                new Enemy(390, 100, 140, 100, "enemy.png"),
                new Enemy(100, 200, 140, 100, "enemy.png"),
                new Enemy(245, 200, 140, 100, "enemy.png"),
                new Enemy(390, 200, 140, 100, "enemy.png"),
                new Enemy(100, 300, 140, 100, "enemy.png"),
                new Enemy(245, 300, 140, 100, "enemy.png"),
                new Enemy(390, 300, 140, 100, "enemy.png"),
